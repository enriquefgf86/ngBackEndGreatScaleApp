...
///==============================================================================
//inicializando el formato o esquema que tendria este modelo de hHospital siendo iden
//tico al inicializado en mongodb exceptuando el id generado por  mongo, para ello se incializa
//una variable llamada hospitalSchema  la cual le seria asignado la construccion
// de un nuevo objeto de tipo Schema previeamente importado de moongoose, en donde
//se le acotarian varios items
//=============================================================================
var hospitalSchema = new Schema({
  user: { type: Schema.Types.ObjectId, ref: "User" }, //haciendo referencia al
  ...
  //saber quien crea el hospital de ahi que el required sea true, y por ultimo se hace referencia
  ...
  //necesarios en este esquema de hospital(name), especificandose que su tipo seria string
  //y seria requerido (true), en donde de no cumplirse dicho requerimiento , trigerizaria
  //un mensaje ("Name is Necesary")

  img: { type: String, required: false },
  //especificando otro de los items
...
//En este paso se aplica el uniqueValidator sobre el esquema de hospital , verificandose que
// no existan entries duplicados o demas errores por no originalidad del archivo que se
//pretende guardar, para ello se accede a lla variable previamente creada hospitalSchema inicializada
...
//bajo el cual se exporta(Hospital), y el schema o modelo por el cual este
// modulo se rige para futuras collecciones de este tipo (hospitalSchema)
//=============================================================================
