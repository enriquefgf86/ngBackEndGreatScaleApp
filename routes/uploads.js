...
const expressFilePpload=require('express-fileupload')
...
//todos los usuarios
// ===========================================================================
router.put("/:type/:id", validateJwt, uploadFile); //Obtener todos los usuarios
router.get("/:type/:imagePath", validateJwt, downloadFile); //Obtener todos los usuarios
