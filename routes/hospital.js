...
const jasonWebToken = require("../helpers/jasonWebToken");
...
//todos los usuarios
// ===========================================================================
router.get("/",validateJwt,  getAllHospitals); //Obtener todos los usuarios
...
router.post(
  "/",validateJwt,
  [
    check("name", "Hospital name is obligatory").not().isEmpty(),
